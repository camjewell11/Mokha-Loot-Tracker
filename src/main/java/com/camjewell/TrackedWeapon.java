...
enum TrackedWeapon {
    ...
    // ──────────
    // itemIds covers both the loaded (filled) and empty forms so
    // detectWeaponsOnPlayer
    // finds the weapon regardless of whether it currently has darts/scales in it.
    // chargeRecipe is null — blowpipe dart/scale items are tracked directly from
    // the JSON delta.
    ...
    VENATOR_BOW("Venator Bow",
            ...
            new ChargeIngredient[] {
                    new ChargeIngredient(ChargeIngredient.ANCIENT_ESSENCE, 1)
            }),
    ...
    TRIDENT_SEAS("Trident of the Seas",
            ...
            "trident of the seas",
            new ChargeIngredient[] {
                    new ChargeIngredient(ChargeIngredient.DEATH_RUNE, 1),
                    new ChargeIngredient(ChargeIngredient.CHAOS_RUNE, 1),
                    new ChargeIngredient(ChargeIngredient.FIRE_RUNE, 5)
            }),
    ...
    TRIDENT_SWAMP("Trident of the Swamp",
            ...
            new ChargeIngredient[] {
                    ...
                    new ChargeIngredient(ChargeIngredient.CHAOS_RUNE, 1),
                    new ChargeIngredient(ChargeIngredient.FIRE_RUNE, 5),
                    new ChargeIngredient(ChargeIngredient.ZULRAH_SCALE, 1)
            }),
    ...
    SANGUINESTI_STAFF("Sanguinesti Staff",
            ...
            "sanguinesti",
            new ChargeIngredient[] {
                    new ChargeIngredient(ChargeIngredient.BLOOD_RUNE, 3)
            }),
    ...
    TUMEKENS_SHADOW("Tumeken's Shadow",
            ...
            "tumeken",
            new ChargeIngredient[] {
                    new ChargeIngredient(ChargeIngredient.SOUL_RUNE, 2),
                    new ChargeIngredient(ChargeIngredient.CHAOS_RUNE, 5)
            }),
    ...
    EYE_OF_AYAK("Eye of Ayak",
            ...
            "eye of ayak",
            new ChargeIngredient[] {
                    new ChargeIngredient(ChargeIngredient.DEMON_TEAR, 1)
            }),
    ...
    SCYTHE_OF_VITUR("Scythe of Vitur",
            ...
            "scythe",
            new ChargeIngredient[] {
                    new ChargeIngredient(ChargeIngredient.BLOOD_RUNE, 2),
                    new ChargeIngredient(ChargeIngredient.VIAL_OF_BLOOD, 1, 100)
            }),
    ...
    BLADE_OF_SAELDOR("Blade of Saeldor",
            ...
            "blade of saeldor",
            new ChargeIngredient[] {
                    new ChargeIngredient(ChargeIngredient.CRYSTAL_SHARD, 1, 100, true)
            }),
    ...
    // Includes cyan and red recolor variants (charged + uncharged each).
    ...
    static final class ChargeIngredient {
        ...
        static final int DEMON_TEAR = 31111; // ItemID.DEMON_TEAR
    ...
    /**
     * Lowercase substring expected in a "check charges" chat message for this
     * weapon.
     */
    final String chatKeyword;
    /**
     * Charge recipe for cost calculation. Null for BLOWPIPE_JSON weapons (items
     * tracked
    ...
    static TrackedWeapon fromConfigKey(String key) {
        ...
        for (TrackedWeapon w : values()) {
            if (w.tictacConfigKey.equals(key))
                return w;
        }
        return null;
    }
    ...
    /**
     * Returns the INTEGER-format TrackedWeapon whose canonical item ID matches, or
     * null.
     */
    static TrackedWeapon fromCanonicalItemId(int itemId) {
        if (itemId <= 0)
            return null;
        for (TrackedWeapon w : values()) {
            if (w.configFormat == ConfigFormat.INTEGER && w.itemIds[0] == itemId)
                return w;
        }
        return null;
    }
    ...
    /**
     * Returns true if itemId matches any item ID declared for an INTEGER-format
     * weapon.
    ...
    static boolean isConfigChargeItemId(int itemId) {
        if (itemId <= 0)
            return false;
        for (TrackedWeapon w : values()) {
            if (w.configFormat != ConfigFormat.INTEGER)
                continue;

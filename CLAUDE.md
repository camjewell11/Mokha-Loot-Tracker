...
`MokhaLootTrackerConfig` exposes 9+ settings: item value exclusions, sort mode (`MokhaDisplaySortMode`), Mokhaiotl Cloth value override, loot alerts, performance/dryness display toggles.
